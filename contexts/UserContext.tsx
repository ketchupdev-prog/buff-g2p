...
export function UserProvider({ children }: { children: React.ReactNode }) {
  ...
  const loadFromStorage = useCallback(async () => {
    try {
      const [storedProfile, storedBuffrId, storedMasked, storedExpiry] = await Promise.all([
  ...
  const value = useMemo<UserContextValue>(
    ...
    [profile, buffrId, cardNumberMasked, expiryDate, setProfile, setBuffrId, clearUser, isLoaded]
  );
