...
export type RootStackParamList = {
  ...
  'onboarding/index': undefined;
  'onboarding/phone': { inviteCode?: string } | undefined;
  ...
  '/(authenticated)/pay-merchant/success': undefined;
  'cash-out/index': undefined;
  
  // ─── Bills ─────────────────────────────────────────────────────────────
  '/bills': undefined;
  '/(authenticated)/bills': undefined;
  '/(authenticated)/bills/index': undefined;
  ...
  // ─── Location Finder ───────────────────────────────────────────────────
  '/(authenticated)/location-finder': undefined;
  '/(authenticated)/location-finder/index': {
    tab?: string;
    service?: string;
  };
  
  // ─── Vouchers ──────────────────────────────────────────────────────────
  '/(authenticated)/vouchers': undefined;
  '/(authenticated)/vouchers/index': undefined;
  '/(authenticated)/vouchers/[id]': { id: string };
  'voucher/index': undefined;
  
  // ─── Bank Accounts ─────────────────────────────────────────────────────
  '/(authenticated)/bank-accounts': undefined;
  '/(authenticated)/bank-accounts/index': undefined;
  
  // ─── Settings ──────────────────────────────────────────────────────────
  '/(authenticated)/settings': undefined;
  '/(authenticated)/settings/index': undefined;
...
export type CompositeNavProp<T extends keyof RootStackParamList> = CompositeNavigationProp<
  StackNavigationProp<RootStackParamList, Extract<T, string>>,
