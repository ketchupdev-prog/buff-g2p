  ...
  const {
    ...
    onValidScan: (rawData, parsedData) => {
      ...
      router.push({
        ...
        params: {
          recipientId: parsedData?.data?.smartpayId || undefined,
          recipientName: parsedData?.data?.merchantName || '',
          // NAMQR doesn't include a phone field; provide an empty placeholder for the example.
          recipientPhone: '',
          recipientSmartpayId: parsedData?.data?.smartpayId || undefined,
        },
      });
    },
