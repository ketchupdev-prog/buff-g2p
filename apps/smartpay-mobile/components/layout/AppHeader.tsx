...
export function AppHeader({
  ...
  const avatarResolved = avatarUri ? getAvatarImageSource(avatarUri) : null;

  return (
    <BlurView
      intensity={Platform.OS === 'ios' ? 80 : 100}
      tint="light"
      // Let touches reach header controls (bell/avatar); expo-blur can otherwise eat presses on some OS versions.
