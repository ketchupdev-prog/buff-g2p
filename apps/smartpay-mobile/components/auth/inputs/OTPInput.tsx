  ...
  return (
    <View style={styles.container}>
      ...
      <CodeField
        ref={ref}
        {...props}
        // react-native-confirmation-code-field requires an explicit InputComponent for correct typing
        ...
        // Platform.select() is typed as `string | undefined`, but TextInput's autoComplete expects a string literal union.
        autoComplete={
          Platform.select({ android: 'sms-otp', default: 'one-time-code' }) as
            | 'sms-otp'
            | 'one-time-code'
            | undefined
        }
