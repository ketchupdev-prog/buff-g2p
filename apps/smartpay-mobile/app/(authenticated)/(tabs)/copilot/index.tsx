...
const styles = StyleSheet.create({
  ...
  balanceLabel: { ...ds.typography.textStyles.caption, color: ds.colors.neutral.textSecondary },
  balanceValue: { ...ds.typography.textStyles.body, color: ds.colors.neutral.text, fontWeight: '600' },
});
