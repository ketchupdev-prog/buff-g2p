...
export default function ConsentReviewScreen() {
  ...
  async function handleApprove() {
    ...
    try {
      ...
      const response = await fetch(`${process.env.EXPO_PUBLIC_API_BASE_URL}/api/v1/obs/v1/authorize/confirm`, {
        method: 'POST',
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            setProcessing(true);
            try {
              await fetch(`${process.env.EXPO_PUBLIC_API_BASE_URL}/api/v1/obs/v1/authorize/confirm`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                  consentId: consent!.consentId,
