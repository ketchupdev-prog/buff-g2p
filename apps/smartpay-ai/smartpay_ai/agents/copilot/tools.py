...
async def _make_api_request(
    ...
    Args:
        ...
        endpoint: API endpoint path (e.g., "/api/v1/wallets")
...
async def add_group_members_tool(
    ...
    **kwargs: Any,
    ...
    return await _make_api_request(
        method="POST",
        endpoint=f"/api/v1/groups/{group_id}/members",
        auth_token=auth_token,
        json_data={
...
async def remove_group_member_tool(
    ...
    **kwargs: Any,
    ...
    return await _make_api_request(
        method="DELETE",
        endpoint=f"/api/v1/groups/{group_id}/members/{member_id}",
        auth_token=auth_token,
    )
...
async def split_bill_tool(
    ...
    **kwargs: Any,
    ...
    return await _make_api_request(
        method="POST",
        endpoint=f"/api/v1/groups/{group_id}/split",
        auth_token=auth_token,
        json_data={
...
async def contribute_to_group_tool(
    ...
    **kwargs: Any,
    ...
    return await _make_api_request(
        method="POST",
        endpoint=f"/api/v1/groups/{group_id}/contribute",
        auth_token=auth_token,
        json_data={
            "amount": amount,
            "wallet_id": wallet_id,
...
async def send_from_group_tool(
    ...
    **kwargs: Any,
    ...
    return await _make_api_request(
        method="POST",
        endpoint=f"/api/v1/groups/{group_id}/send",
        auth_token=auth_token,
        json_data={
            "recipient": recipient,
            "amount": amount,
...
async def initiate_cashout_tool(
    ...
    **kwargs: Any,
    ...
    return await _make_api_request(
        method="POST",
        endpoint="/api/v1/cashout/initiate",
        auth_token=auth_token,
        json_data={
            "amount": amount,
            "wallet_id": wallet_id,
...
async def join_group_tool(
    ...
    **kwargs: Any,
    ...
    return await _make_api_request(
        method="POST",
        endpoint=f"/api/v1/groups/{group_id}/join",
        auth_token=auth_token,
        json_data={
