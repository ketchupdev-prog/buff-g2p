...
This script:
1. Reads JSON Schema files from shared_config/types/
...
def main():
    """Main entry point."""
    # Paths relative to monorepo structure
    # This script lives in packages/shared-types/
    script_dir = Path(__file__).parent
    project_root = script_dir.parent.parent
    
    # Input: JSON schema files in shared-types/json/
    schema_dir = script_dir / "json"
    
    # Output: TypeScript types in shared-types/typescript/
    ts_output_dir = script_dir / "typescript"
    
    # Output: Python types in shared-types/python/
    py_output_dir = script_dir / "python"
    
    print("=" * 60)
    print("SmartPay Type Generator (Monorepo)")
    print("=" * 60)
    print()
