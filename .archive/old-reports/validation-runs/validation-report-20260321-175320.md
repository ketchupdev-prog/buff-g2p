...
- **Generated (UTC):** 2026-03-21T15:53:20Z
- **Run ID:** 20260321-175320
- **TSV:** `validation-run-20260321-175320.tsv`
...
| Fail | 1 |
| Skip | 14 |
| Avg response time (passed, ms) | 911.5 |
| Max response time (passed, ms) | 13208 |
...
|---------|------|--------|-----|----------|--------|-----------|--------|--------|
| health | Backend GET /health | GET | `http://localhost:4000/health` | 200 | 200 | 14 | PASS |  |
| health | Backend GET /health/db | GET | `http://localhost:4000/health/db` | 200|503 | 200 | 1690 | PASS |  |
| health | AI GET /health | GET | `http://localhost:8000/health` | 200 | 200 | 10 | PASS |  |
| health | AI GET /api/v1/health/detailed | GET | `http://localhost:8000/api/v1/health/detailed` | 200 | 200 | 515 | PASS |  |
...
| locations | GET /api/v1/atms/nearby (no auth) | GET | `http://localhost:4000/api/v1/atms/nearby?lat=-22.5597&lng=17.0832&radius` | 401 | 401 | 2 | PASS |  |
| transactions | GET /api/v1/transactions/summary (no auth) | GET | `http://localhost:4000/api/v1/transactions/summary` | 401 | 401 | 4 | PASS |  |
| ai-copilot | POST /api/v1/copilot/chat (empty body → 422) | POST | `http://localhost:8000/api/v1/copilot/chat` | 422 | 422 | 3 | PASS |  |
| ai-copilot | POST /api/v1/copilot/chat (minimal) | POST | `http://localhost:8000/api/v1/copilot/chat` | 200|422|500 | 200 | 13208 | PASS |  |
| ai-ml | GET /api/v1/ml/models | GET | `http://localhost:8000/api/v1/ml/models` | 200|500 | 500 | 3 | PASS |  |
| ai-ml | GET /api/v1/ml/health | GET | `http://localhost:8000/api/v1/ml/health` | 200|500 | 200 | 5 | PASS |  |
| ai-ml | POST /api/v1/ml/predict (empty → 422) | POST | `http://localhost:8000/api/v1/ml/predict` | 422 | 422 | 6 | PASS |  |
| ai-analytics | GET /api/v1/analytics/system/info | GET | `http://localhost:8000/api/v1/analytics/system/info` | 200|500 | 200 | 17 | PASS |  |
...
| auth | Backend profile without token → 401 | GET | `http://localhost:4000/api/v1/user/profile` | 401 | 401 | 2 | PASS |  |
| auth | AI auth middleware (documented) | INFO | `http://localhost:8000` | n/a | - | - | PASS | Public: /health, /api/v1/health/detailed, /docs, /openapi.json |
...
| legacy | request-otp | POST | `http://localhost:4000/api/v1/auth/request-otp` | 400|404 | 000000 | - | FAIL |  |
...
- **request-otp** — got HTTP 000000 (expected 400|404) — `http://localhost:4000/api/v1/auth/request-otp`
