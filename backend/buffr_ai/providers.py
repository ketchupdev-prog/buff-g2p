"""
LLM provider factory for Buffr AI agents.

Location: backend/buffr_ai/providers.py
Purpose: Resolve LLM model from env (OpenAI, Anthropic, DeepSeek). Used by companion and analyst agents.
"""
...
def get_llm_model(model_name: Optional[str] = None, **kwargs: Any) -> Any:
    ...
    if provider == "deepseek":
        ...
        # DeepSeek model names: deepseek-chat, deepseek-coder, etc. (not gpt-4o)
