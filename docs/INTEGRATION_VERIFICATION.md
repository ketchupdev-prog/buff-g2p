...
│   ├── data/                    # Historical training data (9 CSV files)
│   ├── ml_service.py            # Unified ML service used by ml_endpoint
...
All migrations live in `backend/migrations/` and are run by one command.

| # | File | Purpose |
|---|------|---------|
| 1 | `001_prd_schema.sql` | Core schema (users, wallets, vouchers, transactions, etc.) |
...
| **Wallets** | `GET/POST /api/v1/mobile/wallets`, `PATCH/DELETE wallets/:id`, `POST wallets/:id/add-money`, `POST wallets/:id/cashout` |
...
| Trained model weights | `backend/buffr_ai/models/` | ✅ Present |
| Training data | `backend/buffr_ai/data/` (9 CSV files) | ✅ Present |
...
|-------|-------------|--------|
| Fraud Detection | ROC-AUC: 0.9018 | ✅ Production Ready |
| Transaction Classification | Accuracy: 99.79% | ✅ Production Ready |
| Spending Analysis | 8 Personas | ✅ Production Ready |
| Credit Scoring | Production Ready | ✅ Production Ready |
| Churn Prediction | Production Ready | ✅ Production Ready |
| NPS Scoring | Production Ready | ✅ Production Ready |
| Digital Adoption | Production Ready | ✅ Production Ready |
| Beneficiary Segmentation | Production Ready | ✅ Production Ready |
| Voucher Forecast | Production Ready | ✅ Production Ready |
| Expiry Risk | Production Ready | ✅ Production Ready |
| Agent Demand | Production Ready | ✅ Production Ready |
