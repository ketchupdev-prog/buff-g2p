...
export default function SmartPayRedeemScreen() {
  return (
    <SafeAreaView style={styles.safe}>
      <Stack.Screen options={{ headerShown: true, title: 'Redeem via SmartPay', headerBackTitleVisible: false, headerTintColor: '#1E293B', headerStyle: { backgroundColor: '#fff' }, headerTitleStyle: { fontSize: 18, fontWeight: '600', color: '#020617' } }} />
      <View style={styles.center}>
        <Ionicons name="people-outline" size={48} color="#CBD5E1" />
        <Text style={styles.title}>Redeem via SmartPay</Text>
