/**
 * Voucher Wallet Deposit Success – Buffr G2P.
 * §3.4 Voucher redeemed → added to wallet.
 * Animated with SuccessIcon + Confetti + gamification event.
 */
...
export default function WalletDepositSuccessScreen() {
  const { amount, voucherRef } = useLocalSearchParams<{
    amount?: string;
    voucherRef?: string;
  }>();
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.container}>
        ...
        <Animated.View style={[styles.card, cardStyle]}>
          <Text style={styles.title}>Voucher Redeemed!</Text>
          ...
          {voucherRef ? (
            <View style={styles.refBox}>
              <Text style={styles.refLabel}>Voucher Reference</Text>
              <Text style={styles.refValue}>{voucherRef}</Text>
            </View>
          ) : null}
        </Animated.View>
