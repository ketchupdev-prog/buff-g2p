...
export default function VoucherHistoryScreen() {
  return (
    <SafeAreaView style={styles.safe}>
      <Stack.Screen options={{ headerShown: true, title: 'Voucher History', headerBackTitleVisible: false, headerTintColor: '#1E293B', headerStyle: { backgroundColor: '#fff' }, headerTitleStyle: { fontSize: 18, fontWeight: '600', color: '#020617' } }} />
      <View style={styles.center}>
        <Ionicons name="time-outline" size={48} color="#CBD5E1" />
        <Text style={styles.title}>Voucher History</Text>
