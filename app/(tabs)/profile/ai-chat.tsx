...
const FAQ_DB: FAQ[] = [
  ...
  },
  {
    ...
    answer: 'Need help? Go to Profile → Help & Support or call Buffr support at +264 61 000 0000 (Mon–Fri, 08:00–17:00). You can also email support@buffr.na or chat with us here anytime.',
  },
];

const WELCOME = 'Hi! I\'m the Buffr assistant. Ask me about:\n• Vouchers & grants\n• Cash out & withdrawals\n• Bills & airtime\n• Loans\n• Security & PIN\n• Finding agents & ATMs\n\nHow can I help?';

const FALLBACK = 'I\'m not sure about that yet. For specific account issues, contact Buffr support at +264 61 000 0000 or email support@buffr.na.\n\nYou can also try asking about: vouchers, cash out, bills, loans, agents, or security.';
