 ...
 * §3.5 Settings sub-screen. App name, version, legal links.
      ...
      <SafeAreaView style={styles.safe} edges={['top']}>
        ...
        <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <Text style={styles.body}>
            Government-to-Person vouchers, wallet, and payments. Receive grants, send money, pay bills, and cash out at agents.
          </Text>
        </ScrollView>
      </SafeAreaView>
    </View>
...
const styles = StyleSheet.create({
  ...
  version: { ...designSystem.typography.textStyles.bodySm, color: designSystem.colors.neutral.textSecondary, marginBottom: 12 },
